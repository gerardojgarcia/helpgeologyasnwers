...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"geo.js":[function(require,module,exports) {
/// View More 
var rowslength = 4;
...
document.getElementById("loadMoreprodDiv").onclick = function () {
  ...
  showOnly(document.querySelectorAll(".topic-card"), x); //$("#showlessprodDiv").show();
...
document.getElementById("showlessprodDiv").onclick = function () {
  ...
  document.querySelector("#showlessprodDiv").style.display = "block"; //$("#loadMoreprodDiv").show();
  //$("#showlessprodDiv").show();

  if (x == 4) {
    document.querySelector("#showlessprodDiv").style.display = "none"; //$("#showlessprodDiv").hide();
  }
};
...
var playVideo = document.querySelectorAll('[data-modal-target]');
var closeVideo = document.querySelectorAll('[data-close-button]');
...
closeVideo.forEach(function (button) {
  button.addEventListener('click', function () {
...
var navSlide = function navSlide() {
  ...
  navLinks.forEach(function (link, index) {
    link.style.animation = "navLinkFade 0.5s ease forwards ".concat(index / 7, "s");
    console.log(index);
  });
};
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","geo.js"], null)
//# sourceMappingURL=/geo.7e9b5712.js.map